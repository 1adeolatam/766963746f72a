...
public class MasterLock extends Lock {
    ...
    public String LOCK_MANUFACTURER = "Master";
    public int MIN_COMBO_VALUE = 0;
    public int MAX_COMBO_VALUE = 39;
    public int NUMBER_OF_DIGITS = 3;

    private final int digit01 = (int) (Math.random() * 40);
    private final int digit02 = (int) (Math.random() * 40);
    private final int digit03 = (int) (Math.random() * 40);
